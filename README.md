...
What's in this repo
Cohort Analysis.md : Decision, North Star Metrics, Recommendations, Financial Impact, and Caveats (non-technical, decision-focused)
...
Full findings and recommendations in the Cohort Analysis.
